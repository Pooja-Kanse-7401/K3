            ...
            <div className='bg-white'>
                ...
                <div className='h-auto flex justify-start items-center flex-col'>
                    ...
                    <div className='md:w-[40%] w-[100%] flex justify-center items-center flex-col'>
                        <h1 className='md:text-4xl text-2xl mt-2 font-bold text-center text-zinc-900 mb-10'>Log in</h1>
                        <form action="" className='w-[90%]'>
                            ...
                            <button className='border rounded-xl border-purple-900 text-indigo-950 text-xl w-[100%] my-4 font-bold flex justify-center items-center mb-28'>Login with <Image src="/google.png" alt="" width={200} height={200} className='w-12' /></button>
                        </form>
                    </div>
                </div>
            </div>
