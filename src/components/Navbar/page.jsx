...
const Page = () => {
    ...
    return (
        <>
            <nav className='flex justify-center items-center flex-col'>
                <div id="navBar" className=' text-purple-900 flex justify-around items-center h-[10vh] shadow shadow-fuchsia-900 w-[100%] gap-1 md:gap-80'>
                    <ul className='flex justify-center items-center gap-2'>
                        ...
                        <p className='md:text-sm text-xs font-semibold text-center'>Athleisure</p>
                    </ul>
                    <ul className='flex justify-center items-center gap-1 md:gap-4'>
                        ...
                        <Link href="/Login" className='border text-sm rounded-md border-purple-900 p-1 px-2 hover:bg-purple-900 hover:text-white'>LOGIN</Link>
                        <Link href="/Signup" className='border text-sm rounded-md border-purple-900 p-1 px-2 hover:bg-purple-900 hover:text-white'>SIGNUP</Link>
                ...
                <div id="sideNav" className='md:flex z-20 hidden justify-around items-center w-[100%] mt-5'>
                    <ul className='flex justify-center items-center flex-wrap gap-1 md:gap-5 '>
                        <Link href="/Home" className={ `${router.pathname == '/Home' ? "text-purple-900 border-t-2 border-purple-900 animate-bounce" : "text-white"} font-semibold text-sm hover:animate-bounce hover:text-purple-900 hover:border-t-2 hover:border-purple-900 p-1 pb-2 mt-2`}>Home</Link>
                        <Link href="/About" className={`${router.pathname == '/About' ? "text-purple-900 border-t-2 border-purple-900 animate-bounce" : "text-purple-900 border-t-2 border-purple-900 animate-bounce"} font-semibold text-sm hover:animate-bounce hover:text-purple-900 hover:border-t-2 hover:border-purple-900 p-1 pb-2 mt-2`}>About Us</Link>
                        <Link href="/RaceCategories" className={`${router.pathname == '/RaceCategories' ? "text-red-900 border-t-2 border-purple-900 animate-bounce" : "text-white"} font-semibold text-sm hover:animate-bounce hover:text-purple-900 hover:border-t-2 hover:border-purple-900 p-1 pb-2 mt-2`}>Race Categories</Link>
                        <Link href="/Events" className={`${router.pathname == '/Events' ? "text-purple-900 border-t-2 border-purple-900 animate-bounce" : "text-white"} font-semibold text-sm hover:animate-bounce hover:text-purple-900 hover:border-t-2 hover:border-purple-900 p-1 pb-2 mt-2`}>Upcoming Events</Link>
                        <Link href="/Contact" className={`${router.pathname == '/Contact' ? "text-purple-900 border-t-2 border-purple-900 animate-bounce" : "text-white"} font-semibold text-sm hover:animate-bounce hover:text-purple-900 hover:border-t-2 hover:border-purple-900 p-1 pb-2 mt-2`}>Contact Us</Link>
                    </ul>
            ...
            <div id="subNav" className={`${navOpen ? "block" : "hidden"} md:hidden w-[100%] h-auto text-right absolute top-18 right-0 bg-white/85 z-50 flex justify-center items-start`}>
                <ul className='w-[100%] flex justify-center items-center mr-2 flex-col'>
                    ...
                    <Link href="/Contact" className='font-semibold hover:animate-bounce text-sm my-1 text-purple-900 hover:border-b-2 border-purple-900 p-1'>Contact Us</Link>
